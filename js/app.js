...
(function () {
  ...
  const TITLE_I18N = {
    ...
    "법과 질서": { ko: "법과 질서", en: "Law and Order", ne: "कानून र व्यवस्था", bn: "আইন ও শৃঙ্খলা", ru: "Закон и порядок", he: "חוק וסדר", ms: "Undang-undang dan Ketenteraman", vi: "Pháp luật và Trật tự", id: "Hukum dan Ketertiban", si: "නීතිය හා පිළිවෙළ", pt: "Lei e Ordem", fr: "Loi et ordre", ta: "சட்டமும் ஒழுங்கும்" },
    "이민 생활": { ko: "이민 생활", en: "Immigrant Life", ne: "आप्रवासी जीवन", bn: "অভিবাসী জীবন", ru: "Жизнь иммигранта", he: "חיי מהגר", ms: "Kehidupan Pendatang", vi: "Cuộc sống nhập cư", id: "Kehidupan Imigran", si: "සංක්‍රමණික ජීවිතය", pt: "Vida de Imigrante", fr: "Vie d'immigré", ta: "குடியேறி வாழ்க்கை" },
    "문화유산": { ko: "문화유산", en: "Cultural Heritage", ne: "सांस्कृतिक सम्पदा", bn: "সাংস্কৃতিক ঐতিহ্য", ru: "Культурное наследие", he: "מורשת תרבותית", ms: "Warisan Budaya", vi: "Di sản văn hóa", id: "Warisan Budaya", si: "සංස්කෘතික උරුමය", pt: "Património Cultural", fr: "Patrimoine culturel", ta: "பண்பாட்டு பாரம்பரியம்" },
    "정보화 사회": { ko: "정보화 사회", en: "Information Society", ne: "सूचना समाज", bn: "তথ্য সমাজ", ru: "Информационное общество", he: "חברת המידע", ms: "Masyarakat Maklumat", vi: "Xã hội thông tin", id: "Masyarakat Informasi", si: "තොරතුරු සමාජය", pt: "Sociedade da Informação", fr: "Société de l'information", ta: "தகவல் சமூகம்" }
  };
